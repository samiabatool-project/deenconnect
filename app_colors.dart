...
class AppColors {
  ...
  static const Color primary = Color.fromARGB(255, 66, 55, 34);
  static const Color primaryDark = Color.fromARGB(255, 54, 42, 24);
  static const Color primaryLight = Color.fromARGB(255, 136, 108, 89);
  ...
  static const Gradient primaryGradient = LinearGradient(
    ...
    colors: [
      Color.fromARGB(255, 54, 42, 24),
      Color.fromARGB(255, 136, 108, 89)
    ],
  );
